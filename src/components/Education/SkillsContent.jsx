        ...
        <div className="column">
          <div className="box">
            <ul className="larger">
              ...
              <li>
                - Databases: PostgreSQL, MySQL, MongoDB, FaunaDB, Firestore
              </li>
              <li>
                - Testing, Performance Monitoring, IDE, Frameworks: IntelliJ
                IDE, Visual Studio JUnit, Maven, ANT, XSLT, Hibernate, Selenium,
                Jest
              </li>
              <li>
        ...
        <div className="column">
          <div className="box">
            <ul className="larger">
              ...
              <li>
                - Time management: Highly organized, consistent and reliable
                with deadlines
              </li>
              <li>- Diligent: Hard working, passionate and responsible</li>
              <li>
                - Focused: Make sure tasks are completed to the required
                standard
              </li>
            </ul>
          </div>
